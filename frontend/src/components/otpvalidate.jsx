            ...
            <div className="space-y-5 rounded-xl bg-transparent bg-opacity-95 shadow-2xl w-auto max-w-md">
                ...
                <div>
                    <div className="pb-6 flex justify-center">
                        <button className=" w-36 py-2 rounded-full font-light text-white  bg-slate-600 hover:bg-slate-800 shadow-md transition duration-300 border-slate-950" onClick={()=> navigate("/resetpassword")}>
                            Validate
                        </button>
                    </div>
                </div>
